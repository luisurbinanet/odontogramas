...
--
-- Servidor: localhost
-- Tiempo de generación: 12-07-2012 a las 23:10:03
...
INSERT INTO `diagnostico` (`iddiagnostico`, `codigo`, `diagnostico`, `pronostico`) VALUES
(1, '237101', 'PULPOTOMÍA ', 'NULL'),
(2, '237102', ' PULPECTOMIA', 'NULL'),
(3, '237200', 'APEXIFICACIÓN O APEXOGENESIS  ', 'NULL'),
(4, '237301', 'TERAPIA DE CONDUCTO RADICULAR EN DIENTES UNIRRADICULARES PERMANENTES', 'NULL'),
(5, '237302', 'TERAPIA DE CONDUCTO RADICULAR EN DIENTES BIRRADICULARES PERMANENTES', 'NULL'),
(6, '237303', 'TERAPIA DE CONDUCTO RADICULAR EN DIENTES MULTIRRADICULARES PERMANENTES', 'NULL'),
(7, '237304', 'TERAPIA DE CONDUCTO RADICULAR EN DIENTES TEMPORALES, UNIRRADICULARES', 'NULL'),
(8, '237305', 'TERAPIA DE CONDUCTO RADICULAR EN DIENTES TEMPORALES, MULTIRRADICULARES', 'NULL'),
(9, '237501', 'PROCEDIMIENTO CORRECTIVO EN RESORCION RADICULAR (INTERNA Y EXTERNA)', 'NULL'),
(10, '237503', 'RECUBRIMIENTO PULPAR DIRECTO', 'NULL'),
(11, '237504', 'RECUBRIMIENTO PULPAR INDIRECTO', 'NULL'),
(12, '237505', 'PRUEBAS DE VITALIDAD PULPAR', 'NULL'),
(13, '232101', 'OBTURACIÓN DENTAL POR SUPERFICIE,  CON  AMALGAMA', 'NULL'),
(14, '232102', 'OBTURACIÓN DENTAL POR SUPERFICIE, CON  RESINA DE FOTOCURADO', 'NULL'),
(15, '232103', 'OBTURACIÓN DENTAL POR SUPERFICIE, CON  IONÓMERO DE VIDRIO', 'NULL'),
(16, '232200', 'OBTURACION TEMPORAL POR DIENTE  ', 'NULL'),
(17, '232300', 'COLOCACIÓN DE PIN MILIMÉTRICO  ', 'NULL'),
(18, '232401', 'RECONSTRUCCIÓN DE ÁNGULO INCISAL, CON RESINA DE FOTOCURADO', 'NULL'),
(19, '232402', 'RECONSTRUCCIÓN  TERCIO INCISAL, CON RESINA DE FOTOCURADO', 'NULL'),
(20, '233100', 'RESTAURACION DE  DIENTES MEDIANTE INCRUSTACION METALICA  ', 'NULL'),
(21, '233200', 'RESTAURACION DE  DIENTES MEDIANTE INCRUSTACION NO  METALICA  ', 'NULL'),
(22, '234101', 'COLOCACION O APLICACIÓN DE CORONA EN ACERO INOXIDABLE ( PARA DIENTES TEMPORALES)', 'NULL'),
(23, '234102', 'COLOCACION O APLICACIÓN DE CORONA EN POLICARBOXILATO  (PARA DIENTES TEMPORALES)', 'NULL'),
(24, '234103', 'COLOCACION O APLICACIÓN DE CORONA EN FORMA PLÁSTICA', 'NULL'),
(25, '234104', 'COLOCACION O APLICACIÓN DE CORONA ACRÍLICA TERMOCURADA', 'NULL'),
(26, '237901', 'BLANQUEAMIENTO DENTAL [INTRINSECO] POR CAUSAS ENDODONTICAS (POR DIENTE)', 'NULL'),
(27, '240500', 'ADAPTACION DE PLACA NEURO MIORELAJANTE  ', 'NULL'),
(28, '247100', 'COLOCACIÓN DE APARATOLOGÍA  FIJA PARA ORTODONCIA (ARCADA)  ', 'NULL'),
(29, '247201', 'COLOCACIÓN DE APARATOLOGÍA REMOVIBLE INTRAORAL PARA  ORTODONCIA  (ARCADA)', 'NULL'),
(30, '247202', 'COLOCACIÓN DE APARATOLOGÍA REMOVIBLE  EXTRAORAL PARA  ORTODONCIA  (ARCADA)', 'NULL'),
(31, '247300', 'COLOCACION DE APARATOS DE RETENCION  ', 'NULL'),
(32, '248100', 'CIERRE DE DIASTEMA (ALVEOLAR,  DENTAL)  ', 'NULL'),
(33, '248200', 'AJUSTAMIENTO OCLUSAL  ', 'NULL'),
(34, '248400', 'REPARACIÓN DE APARATOLOGIA FIJA O REMOVIBLE  ', 'NULL'),
(35, '248800', 'MASCARA FACIAL TERAPEUTICA NCOC', 'NULL'),
(36, '893106', 'CONTROL DE ORTODONCIA FIJA, REMOVIBLE  O TRATAMIENTO ORTOPÉDICO FUNCIONAL  Y  MECÁNICO', 'NULL'),
(37, '893107', 'ELABORACIÓN Y ADAPTACIÓN DE APARATO ORTOPEDICO', 'NULL'),
(38, '893108', 'SESION DE CONTROL DE CRECIMIENTO Y DESARROLLO DENTO-MAXILOFACIAL', 'NULL'),
(39, '935500', 'APLICACIÓN DE ALAMBRE DENTAL  ', 'NULL'),
(40, '973400', 'EXTRACCION DE  APARATOLOGIA ORTODONTICA FIJA  ', 'NULL'),
(41, '230101', 'EXODONCIA DE DIENTES PERMANENTES UNIRRADICULARES.', 'NULL'),
(42, '230102', 'EXODONCIA DE DIENTES PERMANENTES MULTIRRADICULARES.', 'NULL'),
(43, '230201', 'EXODONCIA DE DIENTES TEMPORALES UNIRRADICULARES.', 'NULL'),
(44, '230202', 'EXODONCIA DE DIENTES TEMPORALES MULTIRRADICULARES.', 'NULL'),
(45, '231100', 'EXODONCIA QUIRURGICA UNIRRADICULAR  ', 'NULL'),
(46, '231200', 'EXODONCIA QUIRURGICA MULTIRRADICULAR.  ', 'NULL'),
(47, '231301', 'EXODONCIA DE DIENTE  INCLUIDO', 'NULL'),
(48, '231302', 'EXODONCIA DE INCLUIDOS EN POSICIÓN ECTÓPICA CON ABORDAJE INTRAORAL   (POR DIENTE)', 'NULL'),
(49, '231303', 'EXODONCIA DE INCLUIDOS EN POSICIÓN ECTÓPICA CON ABORDAJE EXTRAORAL(POR DIENTE)', 'NULL'),
(50, '231400', 'EXODONCIAS  MÚLTIPLES CON ALVEOLOPLASTIA, POR CUADRANTE  ', 'NULL'),
(51, '231500', 'COLGAJO DESPLAZADO PARA ABORDAJE DE DIENTE RETENIDO (VENTANA QUIRURGICA)  ', 'NULL'),
(52, '236300', 'IMPLANTE DENTAL ALOPLASTICO (OSEOINTEGRACION)  ', 'NULL'),
(53, '237401', 'CURETAJE APICAL CON APICECTOMIA Y OBTURACION RETROGADA [CIRUGIA PERIRRADICULAR]', 'NULL'),
(54, '237601', 'FISTULIZACION QUIRURGICA POR TREPANACION Y DRENAJE', 'NULL'),
(55, '237602', 'FISTULIZACION QUIRURGICA POR INCISION', 'NULL'),
(56, '242204', 'AUMENTO DE REBORDE PARCIALMENTE EDENTULO ( SIN MATERIAL)', 'NULL'),
(57, '242205', 'AUMENTO DE REBORDE PARCIALMENTE EDENTULO ( CON MATERIAL)', 'NULL'),
(58, '242300', 'PLASTIAS PREPROTESICAS ( AUMENTO DE CORONA CLINICA )  ', 'NULL'),
(59, '242400', 'REPARACION O PLASTIA PERIODONTAL REGENERATIVA ( INJERTOS , MEMBRANAS )  ', 'NULL'),
(60, '243101', 'EXTIRPACIÓN DE LESIÓN BENIGNA ENCAPSULADA EN ENCÍA HASTA DE TRES CENTÍMETROS', 'NULL'),
(61, '243400', 'GINGIVECTOMIA  ', 'NULL'),
(62, '244101', 'ENUCLEACIÓN DE QUISTE (ODONTOGÉNICO O NO ODONTOGÉNICO) HASTA DE  TRES CENTÍMETROS DE DIÁMETRO', 'NULL'),
(63, '244102', 'ENUCLEACIÓN DE QUISTE (ODONTOGÉNICO O NO ODONTOGÉNICO) DE MÁS DE TRES CENTÍMETROS DE DIÁMETRO', 'NULL'),
(64, '244103', 'RESECCIÓN DE TUMOR BENIGNO  O MALIGNO ODONTOGÉNICO', 'NULL'),
(65, '245100', 'REGULARIZACIÓN DE REBORDES POR CUADRANTE  ', 'NULL'),
(66, '245200', 'ALVEOLECTOMÍA (INTERRADICULAR, INTRASEPTAL, RADICAL, SIMPLE, CON INJERTO O IMPLANTE) NCOC', 'NULL'),
(67, '247401', 'FERULIZACION RIGIDA ( SUPERIOR Y/O INFERIOR)', 'NULL'),
(68, '247402', 'FERULIZACION SEMIRIGIDA ( SUPERIOR Y/O INFERIOR)', 'NULL'),
(69, '249101', 'CONTROL DE HEMORRAGIA DENTAL POS QUIRURGICA  ', 'NULL'),
(70, '250201', 'BIOPSIA EN CUÑA O POR TRUCUT DE LENGUA', 'NULL'),
(71, '251000', 'RESECCIÓN DE LESIÓN SUPERFICIAL EN LA LENGUA  ', 'NULL'),
(72, '255100', 'SUTURA DE LACERACIÓN DE LENGUA (GLOSORRAFIA)  ', 'NULL'),
(73, '261201', 'BIOPSIA ESCIONAL DE GLANDULA SALIVAR MENOR  (CON CONDUCTO SALIVAL)', 'NULL'),
(74, '262901', 'RESECCIÓN DE MUCOCELE DE GLANDULA SALIVAL', 'NULL'),
(75, '272301', 'BIOPSIA INCISIONAL DE LABIO', 'NULL'),
(76, '272302', 'BIOPSIA ESCISIONAL DE LABIO', 'NULL'),
(77, '274100', 'FRENILLECTOMIA LABIAL NCOC', 'NULL'),
(78, '274301', 'RESECCIÓN DE LESIÓN BENIGNA DE LA MUCOSA ORAL ,HASTA DE DOS CENTIMETROS DE DIÁMETRO', 'NULL'),
(79, '274302', 'RESECCIÓN DE LESIÓN BENIGNA DE LA MUCOSA ORAL,  MAYOR DE  DOS CENTIMETROS DE DIÁMETRO', 'NULL'),
(80, '274901', 'REMOCIÓN DE CUERPO EXTRAÑO EN TEJIDOS BLANDOS DE LA BOCA', 'NULL'),
(81, '274902', 'RESECCION  DE BRIDAS INTRAORALES', 'NULL'),
(82, '275101', 'SUTURA O REPARACIÓN DE HERIDA HASTA DE CINCO CENTÍMETROS EN  LABIOS', 'NULL'),
(83, '275102', 'SUTURA O REPARACIÓN DE HERIDA DE MÁS DE CINCO CENTÍMETROS EN  LABIOS', 'NULL'),
(84, '275801', 'PROFUNDIZACION O DESCENSO DE PISO DE BOCA CON DESINSERCION DE MILOHIODEO Y/O GENIHIODEO', 'NULL'),
(85, '275901', 'PROFUNDIZACION  DE SURCO VESTIBULAR CON INJERTO MUCOSO', 'NULL'),
(86, '767705', 'REDUCCION Y FIJACION DE LUXACION  DENTO ALVEOLAR QUE COMPROMETE HASTA TRES DIENTES', 'NULL'),
(87, '767706', 'REDUCCION Y FIJACION DE LUXACION DENTO ALVEOLAR QUE COMPROMETE MAS DE TRES DIENTES', 'NULL'),
(88, '240200', 'DETARTRAJE SUBGINGIVAL  (POR CUADRANTE)  ', 'NULL'),
(89, '240300', 'ALISADO RADICULAR, CAMPO CERRADO ( POR SEXTANTE )  ', 'NULL'),
(90, '242201', 'CURETAJE A CAMPO ABIERTO POR SEXTANTE', 'NULL'),
(91, '227101', 'REPARACION DE FISTULA  OROANTRAL Y/U ORONASAL', 'NULL'),
(92, '227200', 'ELEVACION DEL PISO DEL SENO MAXILAR  ', 'NULL'),
(93, '230201', 'EXODONCIA DE DIENTES TEMPORALES UNIRRADICULARES', 'NULL'),
(94, '230202', 'EXODONCIA DE DIENTES TEMPORALES MULTIRRADICULARES', 'NULL'),
(95, '235100', 'REIMPLANTE DE DIENTE  ', 'NULL'),
(96, '235200', 'TRANSPLANTE DE DIENTE ( INTENCIONAL)  ', 'NULL'),
(97, '237701', 'RADECTOMIA (AMPUTACIÓN RADICULAR) UNICA', 'NULL'),
(98, '237702', 'RADECTOMIA (AMPUTACIÓN RADICULAR) MULTIPLE', 'NULL'),
(99, '237800', 'HEMISECCION DEL DIENTE  ', 'NULL'),
(100, '237902', 'EXPLORACION Y MOVILIZACION  DE NERVIO DENTARIO INFERIOR', 'NULL'),
(101, '240100', 'OPERCULECTOMÍA NCOC', 'NULL'),
(102, '240600', 'DRENAJE DE ABSCESOS PERIODONTALES  ', 'NULL'),
(103, '241101', 'BIOPSIA  INCISIONAL DE ENCÍA', 'NULL'),
(104, '241102', 'BIOPSIA ESCISIONAL DE ENCÍA  CON CIERRE PRIMARIO', 'NULL'),
(105, '241103', 'BIOPSIA  ESCISIONAL DE ENCÍA Y RECUBRIMIENTO CON COLGAJO O INJERTO', 'NULL'),
(106, '241200', 'BIOPSIA DE ALVEÓLO  ', 'NULL'),
(107, '242101', 'PLASTIA MUCOGINGIVAL CON INJERTOS PEDICULADOS ( COLGAJOS PEDICULADOS )', 'NULL'),
(108, '242102', 'PLASTIA MUCOGINGIVAL CON INJERTO GINGIVAL LIBRE (CADA DIENTE)', 'NULL'),
(109, '242202', 'CIRUGIA A COLGAJO CON RESECCION RADICULAR ( AMPUTACION, HEMISECCION )', 'NULL'),
(110, '243102', 'EXTIRPACIÓN DE LESIÓN BENIGNA ENCAPSULADA EN ENCÍA DE MÁS DE TRES CENTÍMETROS', 'NULL'),
(111, '243103', 'EXTIRPACIÓN DE LESIÓN BENIGNA NO ENCAPSULADA EN ENCÍA HASTA DE TRES CENTÍMETROS', 'NULL'),
(112, '243104', 'EXTIRPACIÓN DE LESIÓN BENIGNA NO ENCAPSULADA EN ENCÍA DE MÁS DE TRES CENTÍMETROS', 'NULL'),
(113, '243201', 'SUTURA DE LACERACIÓN DE ENCÍA, MENOR DE TRES CENTIMETROS', 'NULL'),
(114, '243202', 'SUTURA DE LACERACIÓN DE ENCÍA, MAYOR DE TRES CENTIMETROS', 'NULL'),
(115, '243301', 'ENUCLEACIÓN DE QUISTE EPIDERMOIDE, VÍA INTRAORAL', 'NULL'),
(116, '244108', 'MARSUPIALIZACION DE QUISTE ODONTOGÉNICO O NO ODONTOGENICO', 'NULL'),
(117, '250100', 'BIOPSIA CERRADA [PUNCION] [ASPIRACION CON AGUJA FINA] DE LENGUA  ', 'NULL'),
(118, '250202', 'BIOPSIA INCISIONAL DE LENGUA', 'NULL'),
(119, '250203', 'BIOPSIA ESCISIONAL DE LENGUA', 'NULL'),
(120, '251100', 'RESECCIÓN DE LESIÓN PROFUNDA EN LA LENGUA  ', 'NULL'),
(121, '256100', 'FRENILLECTOMÍA LINGUAL NCOC', 'NULL'),
(122, '260100', 'SIALOLITOTOMÍA  ', 'NULL'),
(123, '260300', 'DRENAJE DE GLÁNDULA SALIVAL  ', 'NULL'),
(124, '262101', 'MARSUPIALIZACIÓN DE LA RÁNULA', 'NULL'),
(125, '263206', 'SIALOADENECTOMIA  DE GLANDULAS SALIVALES MENORES', 'NULL'),
(126, '270101', 'INCISIÓN Y DRENAJE INTRAORAL EN CAVIDAD BUCAL', 'NULL'),
(127, '270102', 'INCISIÓN Y DRENAJE EXTRAORAL EN CAVIDAD BUCAL', 'NULL'),
(128, '272101', 'BIOPSIA DE UVULA', 'NULL'),
(129, '272102', 'BIOPSIA INCISIONAL DE PALADAR', 'NULL'),
(130, '272103', 'BIOPSIA ESCISIONAL DE PALADAR', 'NULL'),
(131, '272401', 'BIOPSIA DE PARED DE CAVIDAD BUCAL, INCISIONAL O ESCISIONAL', 'NULL'),
(132, '272402', 'BIOPSIA POR ASPIRACION CON AGUJA FINA EN CAVIDAD ORAL [BACAF]', 'NULL'),
(133, '273101', 'EXTIRPACIÓN DE LESIÓN SUPERFICIAL DE PALADAR', 'NULL'),
(134, '273201', 'EXTIRPACIÓN DE LESIÓN PROFUNDA DE PALADAR', 'NULL'),
(135, '275201', 'ESTOMATORRAFIA (SUTURA DE HERIDA EN MUCOSA ORAL)   DE MENOS DE CINCO CENTIMETROS', 'NULL'),
(136, '275202', 'ESTOMATORRAFIA (SUTURA DE HERIDA EN MUCOSA ORAL)   DE MAS DE CINCO CENTIMETROS', 'NULL'),
(137, '275301', 'RESECCIÓN INTRAORAL DE FÍSTULA DE BOCA', 'NULL'),
(138, '275302', 'RESECCIÓN EXTRAORAL DE FÍSTULA DE BOCA', 'NULL'),
(139, '275303', 'CIERRE DE FÍSTULA OROSINUSAL U ORONASAL, CON COLGAJO PALATINO, LINGUAL O BUCAL', 'NULL'),
(140, '275304', 'CIERRE DE FÍSTULA OROSINUSAL CON SINUSOTOMIA, CON O SIN REMOCIÓN DE CUERPO  EXTRAÑO O COLGAJO PALATINO, LINGUAL O BUCAL', 'NULL'),
(141, '276201', 'CORRECCION DE HENDIDURA ALVEOLOPALATINA', 'NULL'),
(142, '276202', 'CIERRE DE HENDIDURA ALVEOLAR CON INJERTO', 'NULL'),
(143, '276203', 'CIERRE DE HENDIDURA ALVEOLAR SIN INJERTO', 'NULL'),
(144, '276300', 'REVISIÓN DE REPARACIÓN DE PALADAR FISURADO NCOC', 'NULL'),
(145, '278200', 'INCISIÓN DE CAVIDAD BUCAL, ESTRUCTURA NO ESPECIFICADA  ', 'NULL'),
(146, '768110', 'INJERTO ÓSEO AUTÓLOGO POR REBORDE ALVEOLAR', 'NULL'),
(147, '768111', 'INJERTO ÓSEO HETEROLOGO POR REBORDE ALVEOLAR', 'NULL'),
(148, '768301', 'REDUCCION CERRADA LUXACION ARTICULACION TEMPORO MANDIBULAR', 'NULL'),
(149, '768302', 'REDUCCION CERRADA LUXACION ARTICULACION TEMPORO MANDIBULAR CON FIJACION INTERMAXILAR', 'NULL'),
(150, '768702', 'RETIRO DE CERCLAJE INTER O INTRA MAXILAR', 'NULL'),
(151, '973300', 'EXTRACCION DE FERULAS DENTALES  ', 'NULL'),
(152, '973600', 'EXTRACCION DE OTRO DISPOSITIVO DE FIJACION MANDIBULAR EXTERNA  ', 'NULL'),
(153, '243105', 'EXTIRPACIÓN DE LESIÓN MALIGNA DE ENCÍA SIN VACIAMIENTO GANGLIONAR NI RESECCION DE ESTRUCTURAS VECINAS U OSEAS', 'NULL'),
(154, '243302', 'ENUCLEACIÓN DE QUISTE EPIDERMOIDE, VÍA EXTRAORAL', 'NULL'),
(155, '244104', 'RESECCIÓN DE TUMOR BENIGNO O MALIGNO ODONTOGÉNICO Y RECONSTRUCCIÓN INMEDIATA CON INJERTO ÓSEO LIBRE', 'NULL'),
(156, '244105', 'RESECCIÓN DE TUMOR BENIGNO O MALIGNO ODONTOGÉNICO Y RECONSTRUCCION CON COLGAJO ÓSEO PEDICULADO', 'NULL'),
(157, '244106', 'RESECCIÓN DE TUMOR BENIGNO O MALIGNO ODONTOGÉNICO Y RECONSTRUCCION CON COLGAJO ÓSEO LIBRE', 'NULL'),
(158, '244107', 'RESECCIÓN DE TUMOR BENIGNO O MALIGNO ODONTOGÉNICO Y RECONSTRUCCION CON PLACA', 'NULL'),
(159, '255902', 'GLOSOPEXIA', 'NULL'),
(160, '256301', 'DRENAJE DE ABSCESO EN LENGUA', 'NULL'),
(161, '261100', 'BIOPSIA CERRADA [PUNCION]  [ASPIRACION CON AGUJA FINA] DE GLÁNDULA O CONDUCTO  SALIVAL  ', 'NULL'),
(162, '264901', 'SIALOPLASTIA (REPARACIÓN DEL CONDUCTO)  SIN INJERTO', 'NULL'),
(163, '264902', 'SIALOPLASTIA (REPARACIÓN DEL CONDUCTO)  CON INJERTO', 'NULL'),
(164, '990103', 'SESION EDUCATIVA GRUPAL POR ODONTOLOGIA', 'NULL'),
(165, '990203', 'SESION EDUCATIVA INDIVIDUAL POR ODONTOLOGIA', 'NULL'),
(166, '990212', 'SESION EDUCATIVA INDIVIDUAL , POR HIGIENE ORAL', 'NULL'),
(167, '997101', 'APLICACIÓN DE SELLANTES DE AUTOCURADO', 'NULL'),
(168, '997102', 'APLICACIÓN DE SELLANTES DE FOTOCURADO', 'NULL'),
(169, '997103', 'TOPICACION DE FLUOR EN GEL', 'NULL'),
(170, '997104', 'TOPICACION DE FLUOR EN SOLUCION', 'NULL'),
(171, '997105', 'APLICACIÓN DE RESINA PREVENTIVA', 'NULL'),
(172, '997106', 'APLICACIÓN DE RESINA PREVENTIVA MÁS SELLANTE', 'NULL'),
(173, '997300', 'CONTROL DE PLACA DENTAL NCOC', 'NULL'),
(174, '997301', 'DETARTRAJE SUPRAGINGIVAL', 'NULL'),
(175, '997500', 'PROFILAXIS DENTAL  ', 'NULL'),
(176, '234201', 'COLOCACION O INSERCIÓN DE  PRÓTESIS FIJA CADA UNIDAD (PILAR Y PÓNTICOS)', 'NULL'),
(177, '234202', 'RECONSTRUCCIÓN DE MUÑONES', 'NULL'),
(178, '234203', 'PERNO O PATRÓN DE NÚCLEO', 'NULL'),
(179, '234204', 'REPARACION DE PROTESIS FIJA', 'NULL'),
(180, '234301', 'COLOCACION O  INSERCIÓN DE PRÓTESIS REMOVIBLE (SUPERIOR O INFERIOR) MUCOSOPORTADA', 'NULL'),
(181, '234302', 'COLOCACION O INSERCIÓN DE PRÓTESIS REMOVIBLE (SUPERIOR O INFERIOR) DENTOMUCOSOPORTADA', 'NULL'),
(182, '234303', 'REPARACION DE PROTESIS REMOVIBLE', 'NULL'),
(183, '234401', 'COLOCACION O  INSERCIÓN DE PRÓTESIS TOTAL MEDIO CASO (SUPERIOR O INFERIOR)', 'NULL'),
(184, '234402', 'COLOCACION O INSERCIÓN DE PRÓTESIS TOTAL (SUPERIOR E INFERIOR)', 'NULL'),
(185, '973500', 'EXTRACCION DE PROTESIS DENTAL  ', 'NULL'),
(186, '870001', 'RADIOGRAFIA DE CRANEO SIMPLE', 'NULL'),
(187, '870002', 'PERFILOGRAMA PARA CEFALOMETRIA', 'NULL'),
(188, '870003', 'RADIOGRAFIA DE BASE DE CRANEO', 'NULL'),
(189, '870101', 'RADIOGRAFIA DE CARA', 'NULL'),
(190, '870102', 'RADIOGRAFIA DE ORBITAS', 'NULL'),
(191, '870104', 'RADIOGRAFIA DE MALAR', 'NULL'),
(192, '870112', 'RADIOGRAFIA DE MAXILAR SUPERIOR', 'NULL'),
(193, '870113', 'RADIOGRAFIA DE MAXILAR INFERIOR', 'NULL'),
(194, '870114', 'RADIOGRAFIA PANORAMICA DE MAXILARES, SUPERIOR E INFERIOR (ORTOPANTOMOGRAFIA)', 'NULL'),
(195, '870120', 'RADIOGRAFIA SUBMENTONIANA-VERTICAL', 'NULL'),
(196, '870130', 'RADIOGRAFIA DE PERFIL DE CARA', 'NULL'),
(197, '870131', 'RADIOGRAFIA DE ARTICULACION TEMPOROMAXILAR (ATM)', 'NULL'),
(198, '870440', 'RADIOGRAFIAS INTRAORALES OCLUSALES', 'NULL'),
(199, '870450', 'RADIOGRAFIAS INTRAORALES PERIAPICALES MILIMETRADAS', 'NULL'),
(200, '870451', 'RADIOGRAFIAS INTRAORALES PERIAPICALES DIENTES ANTERIORES SUPERIORES', 'NULL'),
(201, '870452', 'RADIOGRAFIAS INTRAORALES PERIAPICALES DIENTES ANTERIORES INFERIORES', 'NULL'),
(202, '870453', 'RADIOGRAFIAS INTRAORALES PERIAPICALES  ZONA DE CANINOS', 'NULL'),
(203, '870454', 'RADIOGRAFIAS INTRAORALES PERIAPICALES PREMOLARES', 'NULL'),
(204, '870455', 'RADIOGRAFIAS INTRAORALES PERIAPICALES MOLARES', 'NULL'),
(205, '870456', 'RADIOGRAFIAS INTRAORALES PERIAPICALES JUEGO COMPLETO', 'NULL'),
(206, '870460', 'RADIOGRAFIAS INTRAORALES CORONALES', 'NULL'),
(207, '890203', 'CONSULTA DE PRIMERA VEZ POR ODONTOLOGIA GENERAL', 'NULL'),
(208, '890204', 'CONSULTA DE PRIMERA VEZ POR ODONTOLOGIA ESPECIALIZADA', 'NULL'),
(209, '890303', 'CONSULTA DE CONTROL O DE SEGUIMIENTO DE PROGRAMA POR ODONTOLOGIA GENERAL', 'NULL'),
(210, '890304', 'CONSULTA DE  CONTROL O SEGUIMIENTO DE PROGRAMA POR ODONTOLOGIA ESPECIALIZADA', 'NULL'),
(211, '890401', 'INTERCONSULTA AMBULATORIA', 'NULL'),
(212, '890402', 'INTERCONSULTA INTRAHOSPITALARIA', 'NULL'),
(213, '890503', 'PARTICIPACION EN JUNTA MEDICA, POR OTRO PROFESIONAL DE LA SALUD', 'NULL'),
(214, '893100', 'EXAMEN  O RECONOCIMIENTO DE MUCOSA ORAL Y PERIODONTAL', 'NULL'),
(215, '893101', 'IMPRESION DE ARCO DENTARIO SUPERIOR O  INFERIOR, CON MODELO DE ESTUDIO Y CONCEPTO', 'NULL'),
(216, '893102', 'FOTOGRAFIA CLINICA EXTRAORAL, INTRAORAL , FRONTAL O LATERAL', 'NULL'),
(217, '893103', 'EVALUACIÓN Y MEDICION  ORTODONTICA Y ORTOPEDICA ORAL', 'NULL'),
(218, '893104', 'ESTUDIO DE OCLUSION Y  ARTICULACION TEMPOROMANDIBULAR', 'NULL'),
(219, '893105', 'MASCARA FACIAL  DIAGNOSTICA', 'NULL'),
(220, '893109', 'ANESTESIA LOCAL NO ASOCIADA CON OTROS PROCEDIMIENTOS', 'NULL'),
(221, '269301', 'CATETERIZACIÓN Y SIALOMETRÍA', 'NULL'),
(222, '899001', 'BIOPSIA CON COLORACION BASICA (RUTINA)', 'NULL'),
(223, '899204', 'CITOLOGIA ORAL', 'NULL'),
(224, '901001', 'ANTIBIOGRAMA (DISCO)', 'NULL'),
(225, '901004', 'HONGOS, PRUEBAS DE SENSIBILIDAD', 'NULL'),
(226, '901005', 'Mycobacterium, PRUEBAS DE SENSIBILIDAD', 'NULL'),
(227, '901006', 'Neisseria gonorrhoeae, PRUEBA SE SUSCEPTIBILIDAD', 'NULL'),
(228, '901101', 'COLORACIÓN ÁCIDO ALCOHOL RESISTENTE MODIFICADA Y LECTURA', 'NULL'),
(229, '901102', 'COLORACIÓN DE ALBERT [LOEFFLER] Y LECTURA', 'NULL'),
(230, '901103', 'COLORACIÓN DE AZUL DE METILENO Y LECTURA PARA CUALQUIER MUESTRA', 'NULL'),
(231, '901104', 'COLORACIÓN DE GRAM Y LECTURA PARA CUALQUIER MUESTRA', 'NULL'),
(232, '901105', 'COLORACIÓN PARA ACIDO ALCOHOL RESISTENTE [ZIELH-NIELSEN] Y LECTURA O BACILOSCOPIA', 'NULL'),
(233, '901108', 'COLORACIÓN TRICRÓMICA MODIFICADA Y LECTURA', 'NULL'),
(234, '901110', 'Coloración Metenamina de Gomoris', 'NULL'),
(235, '901111', 'Coloración Gomorry para retículo', 'NULL'),
(236, '901112', 'Coloración tricrómico de Mason', 'NULL'),
(237, '901113', 'Coloración de Mucina', 'NULL'),
(238, '901201', 'Actinomyces, CULTIVO HONGOS', 'NULL'),
(239, '901207', 'Corynebacterium difteriae, CULTIVO', 'NULL'),
(240, '901209', 'CULTIVO DE LÍQUIDOS CORPORALES: BILIS, L.C.R, PERITONEAL, PLEURAL, ASCÍTICO, SINOVIAL, OTROS DIFERENTE A ORINA.', 'NULL'),
(241, '901214', 'CULTIVO PARA MICROORGANISMOS EN CUALQUIER MUESTRA DIFERENTE A MEDULA OSEA, ORINA Y HECES', 'NULL'),
(242, '901215', 'CULTIVO DE ANAEROBIOS DE CUALQUIER MUESTRA DIFERENTE A MEDULA OSEA', 'NULL'),
(243, '901216', 'CULTIVO ESPECIALES PARA OTROS MICROORGANISMOS', 'NULL'),
(244, '901217', 'CULTIVO DE HONGOS MICOSIS PROFUNDA', 'NULL'),
(245, '901218', 'CULTIVO DE HONGOS MICOSIS SUPERFICIAL', 'NULL'),
(246, '901219', 'CULTIVO DE PATOGENOS FACULTATIVOS DE LESIONES ORALES', 'NULL'),
(247, '901220', 'CULTIVO DE PATOGENOS DE BOLSAS PERIODONTALES', 'NULL'),
(248, '905730', 'MERCURIO EN CABELLO Y SANGRE', 'NULL'),
(249, '905731', 'MERCURIO EN ORINA DE 24H', 'NULL'),
(250, '905732', 'PRUEBA DE SNYDER EN SALIVA', 'NULL'),
(251, '905733', 'ESTUDIO SALIVAR COMPLETO', 'NULL'),
(252, '905734', 'DETERMIANCION DEL pH SALIVAR', 'NULL'),
(253, '905735', 'DETERMINACION DE LA CAPACIDAD AMORTIGUADORA SALIVAR', 'NULL'),
(254, '905736', 'TASA DE SECRECION SALIVAR', 'NULL'),
(255, '905737', '"RECUENTO DE S. DEL GRUPO ""MUTANS"""', 'NULL'),
(256, '905738', 'RECUENTO DE LACTOBACILLUS SP', 'NULL'),
(257, '905739', 'RECUENTO DE CANDIDA SP', 'NULL'),
(258, '905740', 'ESTUDIO DE MICROORGANISMOS CARIOGENICOS EN PLACA DENTAL', 'NULL'),
(259, '905741', '"RECUENTO DE S. DEL GRUPO ""MUTANS"" EN PLACA DENTAL"', 'NULL'),
(260, '905742', 'RECUENTO DE LACTOBACILLUS SP EN PLACA DENTAL', 'NULL'),
(261, '905743', 'CAPACIDAD ACIDOGENICA DE LA PLACA DENTAL', 'NULL'),
(262, 'A51105', 'DETERMINACION DE MANGANESO, YODO Y FLUOR EN AGUA Y MUESTRAS BIOLÓGICAS', 'NULL'),
(263, 'A51107', 'Medición de la concentración de Flúor en muestras de bebidas, comidas sólidas, cremas dentales, soluciones recuperadas, soluciones fluoruradas y uñas', 'NULL'),
(264, 'A51108', 'Medición de la concentración de Flúor en muestra de sal', 'NULL'),
(265, 'A51109', 'Medición de la concentración de Yodo en muestra de sal', 'NULL'),
(266, 'A51110', 'Medición de la concentración de Flúor en tejido calcificado', 'NULL'),
(267, '237502', 'PROCEDIMIENTOS CORRECTIVOS EN FRACTURAS RADICULARES', 'NULL'),
(268, '890703', 'CONSULTA DE URGENCIAS, POR ODONTOLOGIA GENERAL', 'NULL'),
(269, '890704', 'CONSULTA DE URGENCIAS, POR ODONTOLOGIA ESPECIALIZADA', 'NULL'),
(270, '271100', 'DRENAJE DE ABSCESO DE PALADAR  ', 'NULL'),
(271, '999991', 'CITA NO CUMPLIDA', 'NULL'),
(272, '999999', 'EXCLUIDOS POR :OBSOLETOS, NO VIGENTES EN COLOMBIA, DESCONOCIDOS O POR SER CRITERIO EXCLUSIVAMENTE TARIFARIO', 'NULL'),
(273, '230201', 'EXODONCIA DE DIENTES TEMPORALES UNIRRADICULARES', 'NULL'),
(274, '230202', 'EXODONCIA DE DIENTES TEMPORALES MULTIRRADICULARES', 'NULL'),
(275, '', '', '');
...
('124546', 'julio', 'ac', '', '', 14, 'masculino', 'soltero', '2012-07-12', 13001, 2131),
