...
--
-- Servidor: localhost
-- Tiempo de generación: 18-07-2012 a las 23:46:14
...
(1, '237101', 'PULPOTOMÍA '),
(2, '237102', ' PULPECTOMIA'),
(3, '237200', 'APEXIFICACIÓN O APEXOGENESIS  '),
(4, '237301', 'TERAPIA DE CONDUCTO RADICULAR EN DIENTES UNIRRADICULARES PERMANENTES'),
(5, '237302', 'TERAPIA DE CONDUCTO RADICULAR EN DIENTES BIRRADICULARES PERMANENTES'),
(6, '237303', 'TERAPIA DE CONDUCTO RADICULAR EN DIENTES MULTIRRADICULARES PERMANENTES'),
(7, '237304', 'TERAPIA DE CONDUCTO RADICULAR EN DIENTES TEMPORALES, UNIRRADICULARES'),
(8, '237305', 'TERAPIA DE CONDUCTO RADICULAR EN DIENTES TEMPORALES, MULTIRRADICULARES'),
(9, '237501', 'PROCEDIMIENTO CORRECTIVO EN RESORCION RADICULAR (INTERNA Y EXTERNA)'),
(10, '237503', 'RECUBRIMIENTO PULPAR DIRECTO'),
(11, '237504', 'RECUBRIMIENTO PULPAR INDIRECTO'),
(12, '237505', 'PRUEBAS DE VITALIDAD PULPAR'),
(13, '232101', 'OBTURACIÓN DENTAL POR SUPERFICIE,  CON  AMALGAMA'),
(14, '232102', 'OBTURACIÓN DENTAL POR SUPERFICIE, CON  RESINA DE FOTOCURADO'),
(15, '232103', 'OBTURACIÓN DENTAL POR SUPERFICIE, CON  IONÓMERO DE VIDRIO'),
(16, '232200', 'OBTURACION TEMPORAL POR DIENTE  '),
(17, '232300', 'COLOCACIÓN DE PIN MILIMÉTRICO  '),
(18, '232401', 'RECONSTRUCCIÓN DE ÁNGULO INCISAL, CON RESINA DE FOTOCURADO'),
(19, '232402', 'RECONSTRUCCIÓN  TERCIO INCISAL, CON RESINA DE FOTOCURADO'),
(20, '233100', 'RESTAURACION DE  DIENTES MEDIANTE INCRUSTACION METALICA  '),
(21, '233200', 'RESTAURACION DE  DIENTES MEDIANTE INCRUSTACION NO  METALICA  '),
(22, '234101', 'COLOCACION O APLICACIÓN DE CORONA EN ACERO INOXIDABLE ( PARA DIENTES TEMPORALES)'),
(23, '234102', 'COLOCACION O APLICACIÓN DE CORONA EN POLICARBOXILATO  (PARA DIENTES TEMPORALES)'),
(24, '234103', 'COLOCACION O APLICACIÓN DE CORONA EN FORMA PLÁSTICA'),
(25, '234104', 'COLOCACION O APLICACIÓN DE CORONA ACRÍLICA TERMOCURADA'),
(26, '237901', 'BLANQUEAMIENTO DENTAL [INTRINSECO] POR CAUSAS ENDODONTICAS (POR DIENTE)'),
(27, '240500', 'ADAPTACION DE PLACA NEURO MIORELAJANTE  '),
(28, '247100', 'COLOCACIÓN DE APARATOLOGÍA  FIJA PARA ORTODONCIA (ARCADA)  '),
(29, '247201', 'COLOCACIÓN DE APARATOLOGÍA REMOVIBLE INTRAORAL PARA  ORTODONCIA  (ARCADA)'),
(30, '247202', 'COLOCACIÓN DE APARATOLOGÍA REMOVIBLE  EXTRAORAL PARA  ORTODONCIA  (ARCADA)'),
(31, '247300', 'COLOCACION DE APARATOS DE RETENCION  '),
(32, '248100', 'CIERRE DE DIASTEMA (ALVEOLAR,  DENTAL)  '),
(33, '248200', 'AJUSTAMIENTO OCLUSAL  '),
(34, '248400', 'REPARACIÓN DE APARATOLOGIA FIJA O REMOVIBLE  '),
(35, '248800', 'MASCARA FACIAL TERAPEUTICA NCOC'),
(36, '893106', 'CONTROL DE ORTODONCIA FIJA, REMOVIBLE  O TRATAMIENTO ORTOPÉDICO FUNCIONAL  Y  MECÁNICO'),
(37, '893107', 'ELABORACIÓN Y ADAPTACIÓN DE APARATO ORTOPEDICO'),
(38, '893108', 'SESION DE CONTROL DE CRECIMIENTO Y DESARROLLO DENTO-MAXILOFACIAL'),
(39, '935500', 'APLICACIÓN DE ALAMBRE DENTAL  '),
(40, '973400', 'EXTRACCION DE  APARATOLOGIA ORTODONTICA FIJA  '),
(41, '230101', 'EXODONCIA DE DIENTES PERMANENTES UNIRRADICULARES.'),
(42, '230102', 'EXODONCIA DE DIENTES PERMANENTES MULTIRRADICULARES.'),
(43, '230201', 'EXODONCIA DE DIENTES TEMPORALES UNIRRADICULARES.'),
(44, '230202', 'EXODONCIA DE DIENTES TEMPORALES MULTIRRADICULARES.'),
(45, '231100', 'EXODONCIA QUIRURGICA UNIRRADICULAR  '),
(46, '231200', 'EXODONCIA QUIRURGICA MULTIRRADICULAR.  '),
(47, '231301', 'EXODONCIA DE DIENTE  INCLUIDO'),
(48, '231302', 'EXODONCIA DE INCLUIDOS EN POSICIÓN ECTÓPICA CON ABORDAJE INTRAORAL   (POR DIENTE)'),
(49, '231303', 'EXODONCIA DE INCLUIDOS EN POSICIÓN ECTÓPICA CON ABORDAJE EXTRAORAL(POR DIENTE)'),
(50, '231400', 'EXODONCIAS  MÚLTIPLES CON ALVEOLOPLASTIA, POR CUADRANTE  '),
(51, '231500', 'COLGAJO DESPLAZADO PARA ABORDAJE DE DIENTE RETENIDO (VENTANA QUIRURGICA)  '),
(52, '236300', 'IMPLANTE DENTAL ALOPLASTICO (OSEOINTEGRACION)  '),
(53, '237401', 'CURETAJE APICAL CON APICECTOMIA Y OBTURACION RETROGADA [CIRUGIA PERIRRADICULAR]'),
(54, '237601', 'FISTULIZACION QUIRURGICA POR TREPANACION Y DRENAJE'),
(55, '237602', 'FISTULIZACION QUIRURGICA POR INCISION'),
(56, '242204', 'AUMENTO DE REBORDE PARCIALMENTE EDENTULO ( SIN MATERIAL)'),
(57, '242205', 'AUMENTO DE REBORDE PARCIALMENTE EDENTULO ( CON MATERIAL)'),
(58, '242300', 'PLASTIAS PREPROTESICAS ( AUMENTO DE CORONA CLINICA )  '),
(59, '242400', 'REPARACION O PLASTIA PERIODONTAL REGENERATIVA ( INJERTOS , MEMBRANAS )  '),
(60, '243101', 'EXTIRPACIÓN DE LESIÓN BENIGNA ENCAPSULADA EN ENCÍA HASTA DE TRES CENTÍMETROS'),
(61, '243400', 'GINGIVECTOMIA  '),
(62, '244101', 'ENUCLEACIÓN DE QUISTE (ODONTOGÉNICO O NO ODONTOGÉNICO) HASTA DE  TRES CENTÍMETROS DE DIÁMETRO'),
(63, '244102', 'ENUCLEACIÓN DE QUISTE (ODONTOGÉNICO O NO ODONTOGÉNICO) DE MÁS DE TRES CENTÍMETROS DE DIÁMETRO'),
(64, '244103', 'RESECCIÓN DE TUMOR BENIGNO  O MALIGNO ODONTOGÉNICO'),
(65, '245100', 'REGULARIZACIÓN DE REBORDES POR CUADRANTE  '),
(66, '245200', 'ALVEOLECTOMÍA (INTERRADICULAR, INTRASEPTAL, RADICAL, SIMPLE, CON INJERTO O IMPLANTE) NCOC'),
(67, '247401', 'FERULIZACION RIGIDA ( SUPERIOR Y/O INFERIOR)'),
(68, '247402', 'FERULIZACION SEMIRIGIDA ( SUPERIOR Y/O INFERIOR)'),
(69, '249101', 'CONTROL DE HEMORRAGIA DENTAL POS QUIRURGICA  '),
(70, '250201', 'BIOPSIA EN CUÑA O POR TRUCUT DE LENGUA'),
(71, '251000', 'RESECCIÓN DE LESIÓN SUPERFICIAL EN LA LENGUA  '),
(72, '255100', 'SUTURA DE LACERACIÓN DE LENGUA (GLOSORRAFIA)  '),
(73, '261201', 'BIOPSIA ESCIONAL DE GLANDULA SALIVAR MENOR  (CON CONDUCTO SALIVAL)'),
(74, '262901', 'RESECCIÓN DE MUCOCELE DE GLANDULA SALIVAL'),
(75, '272301', 'BIOPSIA INCISIONAL DE LABIO'),
(76, '272302', 'BIOPSIA ESCISIONAL DE LABIO'),
(77, '274100', 'FRENILLECTOMIA LABIAL NCOC'),
(78, '274301', 'RESECCIÓN DE LESIÓN BENIGNA DE LA MUCOSA ORAL ,HASTA DE DOS CENTIMETROS DE DIÁMETRO'),
(79, '274302', 'RESECCIÓN DE LESIÓN BENIGNA DE LA MUCOSA ORAL,  MAYOR DE  DOS CENTIMETROS DE DIÁMETRO'),
(80, '274901', 'REMOCIÓN DE CUERPO EXTRAÑO EN TEJIDOS BLANDOS DE LA BOCA'),
(81, '274902', 'RESECCION  DE BRIDAS INTRAORALES'),
(82, '275101', 'SUTURA O REPARACIÓN DE HERIDA HASTA DE CINCO CENTÍMETROS EN  LABIOS'),
(83, '275102', 'SUTURA O REPARACIÓN DE HERIDA DE MÁS DE CINCO CENTÍMETROS EN  LABIOS'),
(84, '275801', 'PROFUNDIZACION O DESCENSO DE PISO DE BOCA CON DESINSERCION DE MILOHIODEO Y/O GENIHIODEO'),
(85, '275901', 'PROFUNDIZACION  DE SURCO VESTIBULAR CON INJERTO MUCOSO'),
(86, '767705', 'REDUCCION Y FIJACION DE LUXACION  DENTO ALVEOLAR QUE COMPROMETE HASTA TRES DIENTES'),
(87, '767706', 'REDUCCION Y FIJACION DE LUXACION DENTO ALVEOLAR QUE COMPROMETE MAS DE TRES DIENTES'),
(88, '240200', 'DETARTRAJE SUBGINGIVAL  (POR CUADRANTE)  '),
(89, '240300', 'ALISADO RADICULAR, CAMPO CERRADO ( POR SEXTANTE )  '),
(90, '242201', 'CURETAJE A CAMPO ABIERTO POR SEXTANTE'),
(91, '227101', 'REPARACION DE FISTULA  OROANTRAL Y/U ORONASAL'),
(92, '227200', 'ELEVACION DEL PISO DEL SENO MAXILAR  '),
(93, '230201', 'EXODONCIA DE DIENTES TEMPORALES UNIRRADICULARES'),
(94, '230202', 'EXODONCIA DE DIENTES TEMPORALES MULTIRRADICULARES'),
(95, '235100', 'REIMPLANTE DE DIENTE  '),
(96, '235200', 'TRANSPLANTE DE DIENTE ( INTENCIONAL)  '),
(97, '237701', 'RADECTOMIA (AMPUTACIÓN RADICULAR) UNICA'),
(98, '237702', 'RADECTOMIA (AMPUTACIÓN RADICULAR) MULTIPLE'),
(99, '237800', 'HEMISECCION DEL DIENTE  '),
(100, '237902', 'EXPLORACION Y MOVILIZACION  DE NERVIO DENTARIO INFERIOR'),
(101, '240100', 'OPERCULECTOMÍA NCOC'),
(102, '240600', 'DRENAJE DE ABSCESOS PERIODONTALES  '),
(103, '241101', 'BIOPSIA  INCISIONAL DE ENCÍA'),
(104, '241102', 'BIOPSIA ESCISIONAL DE ENCÍA  CON CIERRE PRIMARIO'),
(105, '241103', 'BIOPSIA  ESCISIONAL DE ENCÍA Y RECUBRIMIENTO CON COLGAJO O INJERTO'),
(106, '241200', 'BIOPSIA DE ALVEÓLO  '),
(107, '242101', 'PLASTIA MUCOGINGIVAL CON INJERTOS PEDICULADOS ( COLGAJOS PEDICULADOS )'),
(108, '242102', 'PLASTIA MUCOGINGIVAL CON INJERTO GINGIVAL LIBRE (CADA DIENTE)'),
(109, '242202', 'CIRUGIA A COLGAJO CON RESECCION RADICULAR ( AMPUTACION, HEMISECCION )'),
(110, '243102', 'EXTIRPACIÓN DE LESIÓN BENIGNA ENCAPSULADA EN ENCÍA DE MÁS DE TRES CENTÍMETROS'),
(111, '243103', 'EXTIRPACIÓN DE LESIÓN BENIGNA NO ENCAPSULADA EN ENCÍA HASTA DE TRES CENTÍMETROS'),
(112, '243104', 'EXTIRPACIÓN DE LESIÓN BENIGNA NO ENCAPSULADA EN ENCÍA DE MÁS DE TRES CENTÍMETROS'),
(113, '243201', 'SUTURA DE LACERACIÓN DE ENCÍA, MENOR DE TRES CENTIMETROS'),
(114, '243202', 'SUTURA DE LACERACIÓN DE ENCÍA, MAYOR DE TRES CENTIMETROS'),
(115, '243301', 'ENUCLEACIÓN DE QUISTE EPIDERMOIDE, VÍA INTRAORAL'),
(116, '244108', 'MARSUPIALIZACION DE QUISTE ODONTOGÉNICO O NO ODONTOGENICO'),
(117, '250100', 'BIOPSIA CERRADA [PUNCION] [ASPIRACION CON AGUJA FINA] DE LENGUA  '),
(118, '250202', 'BIOPSIA INCISIONAL DE LENGUA'),
(119, '250203', 'BIOPSIA ESCISIONAL DE LENGUA'),
(120, '251100', 'RESECCIÓN DE LESIÓN PROFUNDA EN LA LENGUA  '),
(121, '256100', 'FRENILLECTOMÍA LINGUAL NCOC'),
(122, '260100', 'SIALOLITOTOMÍA  '),
(123, '260300', 'DRENAJE DE GLÁNDULA SALIVAL  '),
(124, '262101', 'MARSUPIALIZACIÓN DE LA RÁNULA'),
(125, '263206', 'SIALOADENECTOMIA  DE GLANDULAS SALIVALES MENORES'),
(126, '270101', 'INCISIÓN Y DRENAJE INTRAORAL EN CAVIDAD BUCAL'),
(127, '270102', 'INCISIÓN Y DRENAJE EXTRAORAL EN CAVIDAD BUCAL'),
(128, '272101', 'BIOPSIA DE UVULA'),
(129, '272102', 'BIOPSIA INCISIONAL DE PALADAR'),
(130, '272103', 'BIOPSIA ESCISIONAL DE PALADAR'),
(131, '272401', 'BIOPSIA DE PARED DE CAVIDAD BUCAL, INCISIONAL O ESCISIONAL'),
(132, '272402', 'BIOPSIA POR ASPIRACION CON AGUJA FINA EN CAVIDAD ORAL [BACAF]'),
(133, '273101', 'EXTIRPACIÓN DE LESIÓN SUPERFICIAL DE PALADAR'),
(134, '273201', 'EXTIRPACIÓN DE LESIÓN PROFUNDA DE PALADAR'),
(135, '275201', 'ESTOMATORRAFIA (SUTURA DE HERIDA EN MUCOSA ORAL)   DE MENOS DE CINCO CENTIMETROS'),
(136, '275202', 'ESTOMATORRAFIA (SUTURA DE HERIDA EN MUCOSA ORAL)   DE MAS DE CINCO CENTIMETROS'),
(137, '275301', 'RESECCIÓN INTRAORAL DE FÍSTULA DE BOCA'),
(138, '275302', 'RESECCIÓN EXTRAORAL DE FÍSTULA DE BOCA'),
(139, '275303', 'CIERRE DE FÍSTULA OROSINUSAL U ORONASAL, CON COLGAJO PALATINO, LINGUAL O BUCAL'),
(140, '275304', 'CIERRE DE FÍSTULA OROSINUSAL CON SINUSOTOMIA, CON O SIN REMOCIÓN DE CUERPO  EXTRAÑO O COLGAJO PALATINO, LINGUAL O BUCAL'),
(141, '276201', 'CORRECCION DE HENDIDURA ALVEOLOPALATINA'),
(142, '276202', 'CIERRE DE HENDIDURA ALVEOLAR CON INJERTO'),
(143, '276203', 'CIERRE DE HENDIDURA ALVEOLAR SIN INJERTO'),
(144, '276300', 'REVISIÓN DE REPARACIÓN DE PALADAR FISURADO NCOC'),
(145, '278200', 'INCISIÓN DE CAVIDAD BUCAL, ESTRUCTURA NO ESPECIFICADA  '),
(146, '768110', 'INJERTO ÓSEO AUTÓLOGO POR REBORDE ALVEOLAR'),
(147, '768111', 'INJERTO ÓSEO HETEROLOGO POR REBORDE ALVEOLAR'),
(148, '768301', 'REDUCCION CERRADA LUXACION ARTICULACION TEMPORO MANDIBULAR'),
(149, '768302', 'REDUCCION CERRADA LUXACION ARTICULACION TEMPORO MANDIBULAR CON FIJACION INTERMAXILAR'),
(150, '768702', 'RETIRO DE CERCLAJE INTER O INTRA MAXILAR'),
(151, '973300', 'EXTRACCION DE FERULAS DENTALES  '),
(152, '973600', 'EXTRACCION DE OTRO DISPOSITIVO DE FIJACION MANDIBULAR EXTERNA  '),
(153, '243105', 'EXTIRPACIÓN DE LESIÓN MALIGNA DE ENCÍA SIN VACIAMIENTO GANGLIONAR NI RESECCION DE ESTRUCTURAS VECINAS U OSEAS'),
(154, '243302', 'ENUCLEACIÓN DE QUISTE EPIDERMOIDE, VÍA EXTRAORAL'),
(155, '244104', 'RESECCIÓN DE TUMOR BENIGNO O MALIGNO ODONTOGÉNICO Y RECONSTRUCCIÓN INMEDIATA CON INJERTO ÓSEO LIBRE'),
(156, '244105', 'RESECCIÓN DE TUMOR BENIGNO O MALIGNO ODONTOGÉNICO Y RECONSTRUCCION CON COLGAJO ÓSEO PEDICULADO'),
(157, '244106', 'RESECCIÓN DE TUMOR BENIGNO O MALIGNO ODONTOGÉNICO Y RECONSTRUCCION CON COLGAJO ÓSEO LIBRE'),
(158, '244107', 'RESECCIÓN DE TUMOR BENIGNO O MALIGNO ODONTOGÉNICO Y RECONSTRUCCION CON PLACA'),
(159, '255902', 'GLOSOPEXIA'),
(160, '256301', 'DRENAJE DE ABSCESO EN LENGUA'),
(161, '261100', 'BIOPSIA CERRADA [PUNCION]  [ASPIRACION CON AGUJA FINA] DE GLÁNDULA O CONDUCTO  SALIVAL  '),
(162, '264901', 'SIALOPLASTIA (REPARACIÓN DEL CONDUCTO)  SIN INJERTO'),
(163, '264902', 'SIALOPLASTIA (REPARACIÓN DEL CONDUCTO)  CON INJERTO'),
(164, '990103', 'SESION EDUCATIVA GRUPAL POR ODONTOLOGIA'),
(165, '990203', 'SESION EDUCATIVA INDIVIDUAL POR ODONTOLOGIA'),
(166, '990212', 'SESION EDUCATIVA INDIVIDUAL , POR HIGIENE ORAL'),
(167, '997101', 'APLICACIÓN DE SELLANTES DE AUTOCURADO'),
(168, '997102', 'APLICACIÓN DE SELLANTES DE FOTOCURADO'),
(169, '997103', 'TOPICACION DE FLUOR EN GEL'),
(170, '997104', 'TOPICACION DE FLUOR EN SOLUCION'),
(171, '997105', 'APLICACIÓN DE RESINA PREVENTIVA'),
(172, '997106', 'APLICACIÓN DE RESINA PREVENTIVA MÁS SELLANTE'),
(173, '997300', 'CONTROL DE PLACA DENTAL NCOC'),
(174, '997301', 'DETARTRAJE SUPRAGINGIVAL'),
(175, '997500', 'PROFILAXIS DENTAL  '),
(176, '234201', 'COLOCACION O INSERCIÓN DE  PRÓTESIS FIJA CADA UNIDAD (PILAR Y PÓNTICOS)'),
(177, '234202', 'RECONSTRUCCIÓN DE MUÑONES'),
(178, '234203', 'PERNO O PATRÓN DE NÚCLEO'),
(179, '234204', 'REPARACION DE PROTESIS FIJA'),
(180, '234301', 'COLOCACION O  INSERCIÓN DE PRÓTESIS REMOVIBLE (SUPERIOR O INFERIOR) MUCOSOPORTADA'),
(181, '234302', 'COLOCACION O INSERCIÓN DE PRÓTESIS REMOVIBLE (SUPERIOR O INFERIOR) DENTOMUCOSOPORTADA'),
(182, '234303', 'REPARACION DE PROTESIS REMOVIBLE'),
(183, '234401', 'COLOCACION O  INSERCIÓN DE PRÓTESIS TOTAL MEDIO CASO (SUPERIOR O INFERIOR)'),
(184, '234402', 'COLOCACION O INSERCIÓN DE PRÓTESIS TOTAL (SUPERIOR E INFERIOR)'),
(185, '973500', 'EXTRACCION DE PROTESIS DENTAL  '),
(186, '870001', 'RADIOGRAFIA DE CRANEO SIMPLE'),
(187, '870002', 'PERFILOGRAMA PARA CEFALOMETRIA'),
(188, '870003', 'RADIOGRAFIA DE BASE DE CRANEO'),
(189, '870101', 'RADIOGRAFIA DE CARA'),
(190, '870102', 'RADIOGRAFIA DE ORBITAS'),
(191, '870104', 'RADIOGRAFIA DE MALAR'),
(192, '870112', 'RADIOGRAFIA DE MAXILAR SUPERIOR'),
(193, '870113', 'RADIOGRAFIA DE MAXILAR INFERIOR'),
(194, '870114', 'RADIOGRAFIA PANORAMICA DE MAXILARES, SUPERIOR E INFERIOR (ORTOPANTOMOGRAFIA)'),
(195, '870120', 'RADIOGRAFIA SUBMENTONIANA-VERTICAL'),
(196, '870130', 'RADIOGRAFIA DE PERFIL DE CARA'),
(197, '870131', 'RADIOGRAFIA DE ARTICULACION TEMPOROMAXILAR (ATM)'),
(198, '870440', 'RADIOGRAFIAS INTRAORALES OCLUSALES'),
(199, '870450', 'RADIOGRAFIAS INTRAORALES PERIAPICALES MILIMETRADAS'),
(200, '870451', 'RADIOGRAFIAS INTRAORALES PERIAPICALES DIENTES ANTERIORES SUPERIORES'),
(201, '870452', 'RADIOGRAFIAS INTRAORALES PERIAPICALES DIENTES ANTERIORES INFERIORES'),
(202, '870453', 'RADIOGRAFIAS INTRAORALES PERIAPICALES  ZONA DE CANINOS'),
(203, '870454', 'RADIOGRAFIAS INTRAORALES PERIAPICALES PREMOLARES'),
(204, '870455', 'RADIOGRAFIAS INTRAORALES PERIAPICALES MOLARES'),
(205, '870456', 'RADIOGRAFIAS INTRAORALES PERIAPICALES JUEGO COMPLETO'),
(206, '870460', 'RADIOGRAFIAS INTRAORALES CORONALES'),
(207, '890203', 'CONSULTA DE PRIMERA VEZ POR ODONTOLOGIA GENERAL'),
(208, '890204', 'CONSULTA DE PRIMERA VEZ POR ODONTOLOGIA ESPECIALIZADA'),
(209, '890303', 'CONSULTA DE CONTROL O DE SEGUIMIENTO DE PROGRAMA POR ODONTOLOGIA GENERAL'),
(210, '890304', 'CONSULTA DE  CONTROL O SEGUIMIENTO DE PROGRAMA POR ODONTOLOGIA ESPECIALIZADA'),
(211, '890401', 'INTERCONSULTA AMBULATORIA'),
(212, '890402', 'INTERCONSULTA INTRAHOSPITALARIA'),
(213, '890503', 'PARTICIPACION EN JUNTA MEDICA, POR OTRO PROFESIONAL DE LA SALUD'),
(214, '893100', 'EXAMEN  O RECONOCIMIENTO DE MUCOSA ORAL Y PERIODONTAL'),
(215, '893101', 'IMPRESION DE ARCO DENTARIO SUPERIOR O  INFERIOR, CON MODELO DE ESTUDIO Y CONCEPTO'),
(216, '893102', 'FOTOGRAFIA CLINICA EXTRAORAL, INTRAORAL , FRONTAL O LATERAL'),
(217, '893103', 'EVALUACIÓN Y MEDICION  ORTODONTICA Y ORTOPEDICA ORAL'),
(218, '893104', 'ESTUDIO DE OCLUSION Y  ARTICULACION TEMPOROMANDIBULAR'),
(219, '893105', 'MASCARA FACIAL  DIAGNOSTICA'),
(220, '893109', 'ANESTESIA LOCAL NO ASOCIADA CON OTROS PROCEDIMIENTOS'),
(221, '269301', 'CATETERIZACIÓN Y SIALOMETRÍA'),
(222, '899001', 'BIOPSIA CON COLORACION BASICA (RUTINA)'),
(223, '899204', 'CITOLOGIA ORAL'),
(224, '901001', 'ANTIBIOGRAMA (DISCO)'),
(225, '901004', 'HONGOS, PRUEBAS DE SENSIBILIDAD'),
(226, '901005', 'Mycobacterium, PRUEBAS DE SENSIBILIDAD'),
(227, '901006', 'Neisseria gonorrhoeae, PRUEBA SE SUSCEPTIBILIDAD'),
(228, '901101', 'COLORACIÓN ÁCIDO ALCOHOL RESISTENTE MODIFICADA Y LECTURA'),
(229, '901102', 'COLORACIÓN DE ALBERT [LOEFFLER] Y LECTURA'),
(230, '901103', 'COLORACIÓN DE AZUL DE METILENO Y LECTURA PARA CUALQUIER MUESTRA'),
(231, '901104', 'COLORACIÓN DE GRAM Y LECTURA PARA CUALQUIER MUESTRA'),
(232, '901105', 'COLORACIÓN PARA ACIDO ALCOHOL RESISTENTE [ZIELH-NIELSEN] Y LECTURA O BACILOSCOPIA'),
(233, '901108', 'COLORACIÓN TRICRÓMICA MODIFICADA Y LECTURA'),
(234, '901110', 'Coloración Metenamina de Gomoris'),
(235, '901111', 'Coloración Gomorry para retículo'),
(236, '901112', 'Coloración tricrómico de Mason'),
(237, '901113', 'Coloración de Mucina'),
(238, '901201', 'Actinomyces, CULTIVO HONGOS'),
(239, '901207', 'Corynebacterium difteriae, CULTIVO'),
(240, '901209', 'CULTIVO DE LÍQUIDOS CORPORALES: BILIS, L.C.R, PERITONEAL, PLEURAL, ASCÍTICO, SINOVIAL, OTROS DIFERENTE A ORINA.'),
(241, '901214', 'CULTIVO PARA MICROORGANISMOS EN CUALQUIER MUESTRA DIFERENTE A MEDULA OSEA, ORINA Y HECES'),
(242, '901215', 'CULTIVO DE ANAEROBIOS DE CUALQUIER MUESTRA DIFERENTE A MEDULA OSEA'),
(243, '901216', 'CULTIVO ESPECIALES PARA OTROS MICROORGANISMOS'),
(244, '901217', 'CULTIVO DE HONGOS MICOSIS PROFUNDA'),
(245, '901218', 'CULTIVO DE HONGOS MICOSIS SUPERFICIAL'),
(246, '901219', 'CULTIVO DE PATOGENOS FACULTATIVOS DE LESIONES ORALES'),
(247, '901220', 'CULTIVO DE PATOGENOS DE BOLSAS PERIODONTALES'),
(248, '905730', 'MERCURIO EN CABELLO Y SANGRE'),
(249, '905731', 'MERCURIO EN ORINA DE 24H'),
(250, '905732', 'PRUEBA DE SNYDER EN SALIVA'),
(251, '905733', 'ESTUDIO SALIVAR COMPLETO'),
(252, '905734', 'DETERMIANCION DEL pH SALIVAR'),
(253, '905735', 'DETERMINACION DE LA CAPACIDAD AMORTIGUADORA SALIVAR'),
(254, '905736', 'TASA DE SECRECION SALIVAR'),
(255, '905737', '"RECUENTO DE S. DEL GRUPO ""MUTANS"""'),
(256, '905738', 'RECUENTO DE LACTOBACILLUS SP'),
(257, '905739', 'RECUENTO DE CANDIDA SP'),
(258, '905740', 'ESTUDIO DE MICROORGANISMOS CARIOGENICOS EN PLACA DENTAL'),
(259, '905741', '"RECUENTO DE S. DEL GRUPO ""MUTANS"" EN PLACA DENTAL"'),
(260, '905742', 'RECUENTO DE LACTOBACILLUS SP EN PLACA DENTAL'),
(261, '905743', 'CAPACIDAD ACIDOGENICA DE LA PLACA DENTAL'),
(262, 'A51105', 'DETERMINACION DE MANGANESO, YODO Y FLUOR EN AGUA Y MUESTRAS BIOLÓGICAS'),
(263, 'A51107', 'Medición de la concentración de Flúor en muestras de bebidas, comidas sólidas, cremas dentales, soluciones recuperadas, soluciones fluoruradas y uñas'),
(264, 'A51108', 'Medición de la concentración de Flúor en muestra de sal'),
(265, 'A51109', 'Medición de la concentración de Yodo en muestra de sal'),
(266, 'A51110', 'Medición de la concentración de Flúor en tejido calcificado'),
(267, '237502', 'PROCEDIMIENTOS CORRECTIVOS EN FRACTURAS RADICULARES'),
(268, '890703', 'CONSULTA DE URGENCIAS, POR ODONTOLOGIA GENERAL'),
(269, '890704', 'CONSULTA DE URGENCIAS, POR ODONTOLOGIA ESPECIALIZADA'),
(270, '271100', 'DRENAJE DE ABSCESO DE PALADAR  '),
(271, '999991', 'CITA NO CUMPLIDA'),
(272, '999999', 'EXCLUIDOS POR :OBSOLETOS, NO VIGENTES EN COLOMBIA, DESCONOCIDOS O POR SER CRITERIO EXCLUSIVAMENTE TARIFARIO'),
(273, '230201', 'EXODONCIA DE DIENTES TEMPORALES UNIRRADICULARES'),
(274, '230202', 'EXODONCIA DE DIENTES TEMPORALES MULTIRRADICULARES'),
(275, '', '');
...
INSERT INTO `medico` (`idmedico`, `nombreUsuario`, `clave`, `direccion`, `telefono`, `anio`, `periodo`) VALUES
(123456, 'Julio Barcos', '123456', 'blas de lezo', '6666666', '2012', '2');
...
('123432', 'jkl', 'gsdfgdsf', '543564', '45646', 'masculino', 'soltero', '2012-06-29', 13001, 212),
('1923556344', 'Diana Padilla', 'Campestre', '8670956864', '67676767', 'masculino', 'otro', '1999-04-04', 13001, 8384),
('324345', 'juan', 'dsfsd', '34546', '5467', 'masculino', 'soltero', '2012-07-20', 13001, 12),
('3456', 'arturo', 'manga', '67345454', '56756756', 'masculino', 'soltero', '2012-07-13', 13001, 2134),
('3457', 'oscar', 'vista hermosa', '879087', '967876', 'masculino', 'soltero', '2012-07-10', 13001, 2112),
('89889', 'pepe', 'ewe', '898989', '898989', 'femenino', 'soltero', '2012-05-29', 13001, 411);
...
ALTER TABLE `datosconsulta_has_diagnostico`
  ADD CONSTRAINT `fk_datosConsulta_has_diagnostico_datosConsulta1` FOREIGN KEY (`datosConsulta_iddatosConsulta`) REFERENCES `datosconsulta` (`iddatosConsulta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `datosconsulta_has_diente`
  ADD CONSTRAINT `fk_datosConsulta_has_diente_datosConsulta1` FOREIGN KEY (`datosConsulta_iddatosConsulta`) REFERENCES `datosconsulta` (`iddatosConsulta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `datosconsulta_has_plantratamiento`
  ADD CONSTRAINT `fk_datosConsulta_has_planTratamiento_datosConsulta1` FOREIGN KEY (`datosConsulta_iddatosConsulta`) REFERENCES `datosconsulta` (`iddatosConsulta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `datosconsulta_has_tratamiento`
  ADD CONSTRAINT `fk_datosConsulta_has_tratamiento_datosConsulta1` FOREIGN KEY (`datosConsulta_iddatosConsulta`) REFERENCES `datosconsulta` (`iddatosConsulta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `examenfisicoestomatologico`
  ADD CONSTRAINT `fk_examenFisicoEstomatologico_datosConsulta1` FOREIGN KEY (`datosConsulta_iddatosConsulta`) REFERENCES `datosconsulta` (`iddatosConsulta`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `radiografia`
  ADD CONSTRAINT `fk_radiografia_datosConsulta1` FOREIGN KEY (`datosConsulta_iddatosConsulta`) REFERENCES `datosconsulta` (`iddatosConsulta`) ON DELETE NO ACTION ON UPDATE NO ACTION;
