...
(function(f){
    ...
    c={
        init:function(m,l){
            return this.each(function(){
                var q=f(this),p=q.data("lhpMIV"),o=q.find("img"),n={};
        ...
        getCurrentState:function(){
            var n=f(this),m=n.data("lhpMIV"),l={};
    ...
    d.prototype.iniNav=function(){
        ...
        f.each(r,function(v){
            var w=r[v][0],x=r[v][1],z=r[v][3],y,u;
            if(o.sett[z]){
                l+=t;
        ...
        s.bind("mivChange.lhpMIV",function(w){
            var v="lhp_miv_nav_btt_disab",u="ui-state-hover";
            if(w.allowDown){
    ...
    d.prototype.start=function(){
        ...
        if(this.sett.intNavEnable){
            ...
            this.iniNav();
            this.$mivHol.parent("div").prepend(this.$navHol);
        }
  ...
  *   this.$contentHol.bind("mouseenter.lhpMIV",{
   ...
   **/
    ...
    d.prototype.mousewheelHandler=function(m,p){
        var o=m.data._this,n=(p>0)?o.sm.nextScale():o.sm.prevScale(),l=o.calculateScale(m,n);
        o.animStop();
        o.stopMoving();
        o.stopDirectMoving();
    ...
    d.prototype.showCurrentCoor=function(o){
        var q=o.data._this,l=q.mousePageCoor(o),p=q.$contentHol.position(),m=q.$mivHol.offset(),n=q.$content.width()/q.contentFullSize.w;
    ...
    d.prototype.zooming=function(m,o){
        var n=(o>0)?this.sm.nextScale():this.sm.prevScale(),l=this.calculateScale(m,n);
        this.animStop();
    ...
    d.prototype.directMoveWithInertia=function(){
        var m=this.$contentHol.position().left,l=this.$contentHol.position().top,p=Math.ceil(m+this.speedX),n=Math.ceil(l+this.speedY),o;
        if(!this.movingIntreval){
    ...
    d.prototype.dragging=function(q,o){
        var p=this.sett.draggInertia,m=this.mousePageCoor(q),n=m.x-this.lastMousePageCoor.x,l=m.y-this.lastMousePageCoor.y;
    ...
    d.prototype.draggingHard=function(m,l){
        var q=this.$contentHol.position(),p=q.left+m,n=q.top+l,o=this.getSafeTarget(p,n,m,l);
        this.animStop();
        this.$contentHol.css({
            left:o.x,
            top:o.y
    ...
    d.prototype.draggingWithInertia=function(m,l){
        var p=this.targetX+m,n=this.targetY+l,o;
        if(!this.movingIntreval){
            this.movingIntreval=setInterval(function(q){
                return function(){
                    q.moveWithInertia()
    ...
    d.prototype.getSafeTarget=function(y,w,o,m){
        var l=this.getLimit(this.sm.getScale()),p=l.xMin,s=l.xMax,z=l.yMin,r=l.yMax,n=this.$mivHol.width(),x=this.$mivHol.height(),v=n/2,u=x/2,t=this.contentFullSize.w*this.sm.getScale(),q=this.contentFullSize.h*this.sm.getScale();
        if((m<0)&&(w<z)){
            w=z
        }else{
            if((m>0)&&(w>r)){
    ...
    d.prototype.moveWithInertia=function(){
        var o=this.$contentHol.position(),n=this.sett.dragSmooth,m,l;
    ...
    d.prototype.positioning=function(m){
        var n=m.data._this,l=n.calculatePosInCenter(m);
        n.animStop();
        n.stopMoving();
        n.stopDirectMoving();
    ...
    d.prototype.setProperties=function(A,u,o,z){
        if(this.$content){
            var p={
                ...
                pageX:n.x,
                pageY:n.y
            },w=this.$contentHol.position(),s,v,l=w.left,C=w.top,m=this.$content.width(),t=this.$content.height();
            A=parseFloat(A);
            u=parseFloat(u);
            o=parseFloat(o);
            if(!isNaN(o)){
    ...
    d.prototype.calculatePosInCenter=function(n){
        var o=this.$contentHol.position(),r=this.$mivHol.offset(),m={
            x:(this.$mivHol.width()/2),
            y:(this.$mivHol.height()/2)
        },s=this.mousePageCoor(n),t={
            x:(s.x-r.left),
            y:(s.y-r.top)
        },q,p,l,u;
        q=m.x-t.x;
    ...
    d.prototype.calculateScale=function(q,p){
        var t=this.$mivHol.offset(),o=this.$content.offset(),u=this.mousePageCoor(q),s,n,l,v,m,r;
    ...
    d.prototype.getSafeScale=function(s){
        var u=(s<=0)?0.00001:s,l=this.$mivHol.width(),v=this.$mivHol.height(),t=this.contentFullSize.w,p=this.contentFullSize.h,r=t*u,n=p*u,q=l/t,w=v/p,m=l/v,o=r/n;
        if(this.sett.fitToViewportShortSide){
            if(r<l||n<v){
    ...
    d.prototype.getLimit=function(n){
        var m=-(Math.round(this.contentFullSize.w*n)-this.$mivHol.width()),l=-(Math.round(this.contentFullSize.h*n)-this.$mivHol.height());
        return{
            xMin:m,
            xMax:0,
            yMin:l,
    ...
    d.prototype.getSafeXY=function(w,u,t){
        var l=this.getLimit(t),m=this.$mivHol.width(),v=this.$mivHol.height(),s=m/2,q=v/2,r=this.contentFullSize.w,o=this.contentFullSize.h,p=r*t,n=o*t,A=w,z=u;
        if(p<m){
    ...
    d.prototype.dispatchEventChange=function(){
        var l=this.getCurrentState(),m=f.Event("mivChange",l);
        this.allow=l;
    ...
    d.prototype.getCurrentState=function(){
        ...
        if(this.$content){
            var r=this.$contentHol.position(),n=this.getLimit(this.sm.getScale()),l=this.$content.width(),o=this.$content.height(),q={
                x:(this.$mivHol.width()/2),
                y:(this.$mivHol.height()/2)
    ...
    b.prototype.mouseclickHandler=function(o){
        var q=o.data._this,m=q.mousePageCoor(o),n=q.$mapHol.offset(),l=(m.x-n.left)*q.sett.mainImgWidth/q.$mapWrappHol.width(),p=(m.y-n.top)*q.sett.mainImgHeight/q.$mapWrappHol.height();
        q.$mainHolder.lhpMegaImgViewer("setPosition",l,p)
    };
    
    b.prototype.dragging=function(r){
        var m=this.mousePageCoor(r),n=m.x-this.lastMousePageCoor.x,l=m.y-this.lastMousePageCoor.y,s=this.$vr.position(),q=s.left+n,o=s.top+l,p=this.getSafeTarget(q,o,n,l);
        this.$vr.css({
            left:p.x,
            top:p.y
        });
    ...
    b.prototype.getSafeTarget=function(q,p,n,m){
        var o=0,l=0,s=this.$mapWrappHol.width()-this.$vr.width(),r=this.$mapWrappHol.height()-this.$vr.height();
        if((m<0)&&(p<l)){
            p=l
        }else{
            if((m>0)&&(p>r)){
    ...
    b.prototype.mainHolderSetPosition=function(n,m){
        var l=(n+this.$vr.width()/2)*this.sett.mainImgWidth/this.$mapWrappHol.width(),o=(m+this.$vr.height()/2)*this.sett.mainImgHeight/this.$mapWrappHol.height();
        this.$mainHolder.lhpMegaImgViewer("setPosition",l,o,null,true)
    };
    
    b.prototype.mivChangeHandler=function(q){
        var s=q.data._this,m=s.$mapWrappHol.width(),p=s.$mapWrappHol.height(),r=Math.round(m*((q.wPropViewpContent>1)?1:q.wPropViewpContent)),l=Math.round(p*((q.hPropViewpContent>1)?1:q.hPropViewpContent)),o=Math.round((m/s.sett.mainImgWidth)*q.xPosInCenter-(r/2)),n=Math.round((p/s.sett.mainImgHeight)*q.yPosInCenter-(l/2));
        s.$vr.css({
            width:r,
            height:l,
            left:o,
    ...
    a.prototype.getLimit=function(){
        var p=this.$contentHol.position(),m=-p.left,o=m+this.$mainHolder.width(),l=-p.top,n=l+this.$mainHolder.height();
        return{
            xMin:m,
            xMax:o,
            yMin:l,
    ...
    i.prototype.findEdges=function(){
        var q=this.getInn().offset(),n=this.markers.$mainHolder.offset(),u=this.markers.$contentHol.position(),x=u.left,p=u.top,v=this.getSize(),o=q.left-x-n.left,m=o+v.w,w=q.top-p-n.top,s=w+v.h;
        return({
            L:o,
            R:m,
            T:w,
    ...
    i.prototype.positions=function(m){
        var l=Math.round(this.x*m),n=Math.round(this.y*m);
        this.$m.css({
            left:l,
            top:n
        })
