            ...
            $(function(){
                ...
                $(window).hashchange(function(){
                    ...
                    if(hash == "#listaCursos"){
                        $.ajax({ 
                            type: "POST", 
                            url: "<%=request.getContextPath()%>/formController?action=listarCursos", 
                            success: function() {
                                $.ajax({ 
                                    type: "POST", 
                        ...
                        if(hash == "#nuevoCurso"){
                            $.ajax({ 
                                type: "POST", 
                                url: "/Odontogramas/vista/docente/curso/crear.jsp", 
                                success: function(data) 
                                { 
                                    $("#contenido").html(data);
                                ...
                                if(hash.indexOf("#editarCurso")!=-1){
                                    ...
                                    $.ajax({ 
                                        ...
                                        { 
                                            $.ajax({ 
                                                type: "POST", 
                                                url: "/Odontogramas/vista/docente/curso/editar.jsp",
                                                success: function(data) 
                                                {   $("#contenido").html(data);
                                                } //fin success
                                            }); //fin del $.ajax
                                    ...
                                    /*jajajaj */      if(hash.indexOf("#listaMedicos")!=-1){///jajajajja
                                        var cual = hash.split("&");
                                        var url3 = "<%=request.getContextPath()%>/formController?action=";
                                        url3 = url3.concat(cual[0].substring(1),"&id=",cual[1]);
                                                            ...
                                                            $.ajax({ 
                                                                ...
                                                                { 
                                                                    $.ajax({ 
                                                                        ...
                                                                        {
                                                                            $(".nav-list >li > a").hide();
                                                                            $(".nav-list").append('<li><a href="#menuMedicos" title="Menú de Docentes">Atras</a></li>'                                                        
                                                            ...
                                                            if(hash.indexOf("#verMedico")!=-1){
                                                                ...
                                                                if(hash.indexOf("#editarMedico")!=-1){
                                                                    ...
                                                                    if(hash == "#menuMedicos"){
                                                                        ...
                                                                        $(".nav-list >li").slice(3).remove();
                                                                        $(".nav-list >li > a").hide();
                                                                        $(".nav-list").append('<li><a href="#nuevoCurso">Nuevo Curso</a></li>'
                ...
                <div class="container">
                    ...
                    <ul class="nav pull-right">
                        <li id="fat-menu" class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Bienvenido ${docente.getRowsByIndex()[0][1]} <b class="caret"></b></a>
