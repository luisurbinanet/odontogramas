...
<script type="text/javascript">
    ...
    <c:forEach items="${diagnosticos.rowsByIndex}" var="item" varStatus="iter">
            miArray[${iter.index}] = "${item[2]} - ${item[1]}";
    </c:forEach> 
                ...
                <form class="form-horizontal" id="datos2" method="post">
                    <fieldset>
                        ...
                        <table class="table table-striped table-bordered table-condensed">
                            ...
                            <tbody>
                                <c:forEach items="${datosBasicos.rowsByIndex}" var="row">
                                    <tr>
                                        <td>${row[1]}</td>
                                        <td> <input type="radio" value="si" name="db${row[0] }" ></td>
                                        <td> <input type="radio" value="no" name="db${row[0]}" ></td>
                                        <td> <input type="radio" value="no sabe" name="db${row[0]}" checked></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
                        ...
                        <form action="" id="formDiente" name="formDiente" method="post" style="margin-bottom: 0px;">
                            <fieldset>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="span3">
                                            <div style="text-align: center;margin-left: 25px;" id="dibujarDiente">
                                                ...
                                                <polygon class="parte" id="vestibular1" points="10,6,70,6,55,25,30,25" style="stroke:none; stroke-width:1; stroke-opacity:1; fill:transparent; fill-opacity:1" />
